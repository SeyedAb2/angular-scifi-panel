...
export class CompaniesComponent {
  ...
  // Select
    ...
    // Select2
    selectedSimpleItem1 = 'Compeny Size';
    simpleItems1:any = [];
    ...
    ngOnInit(): void {
      ...
      this.simpleItems1 = ['Compeny Size','Corporate',' Large Enterprise','Micro Business','LogisMedium size'];
    }
    ...
    InvoiceData = [
      {
        ...
        Source1: ' 258',
        mail: 'texistechnologies471&#64;gmail.com',
      ...
      },
      {
        ...
        Source1: ' 335',
        mail: 'marbelsintechsolution9@gmail.com',
        Phone: '8122-2342-4453',
        logo:'./assets/images/company-logos/3.png',
        Company:'MarbelsIntech solution',
