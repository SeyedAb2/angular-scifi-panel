export let badgeTS = `<div class="d-flex flex-wrap gap-2">
...
export let badgeTS1 = `  <div class="d-flex flex-wrap gap-2">
...
export let badgeTS2 = ` <div class="card-body d-flex flex-wrap gap-2">
...
export let badgeTS3 = ` <div class=" d-flex flex-wrap gap-2">
...
export let badgeTS4 = `<div class="card-body d-flex flex-wrap gap-2">
...
export let badgeTS5 = `   <div class="card-body d-flex flex-wrap gap-2">
...
export let badgeTS6 = ` <div class="card-body d-flex flex-wrap gap-2">
...
export let badgeTS7 = `<div class="card-body d-flex flex-wrap gap-2">
...
export let badgeTS8 = `<div class="card-body d-flex flex-wrap gap-2">
...
export let badgeTS9 = ` <div class="card-body d-flex flex-wrap gap-2">
...
export let badgeTS10 = ` <div class="card-body">
...
export let badgeTS12 = ` <div class="card-body">
