...
export let listGrpTS1 = `<div class="card-body">
<ul class="list-group">
...
export let listGrpTS2 = ` <ul class="list-group">
...
export let listGrpTS3 = `<ul class="list-group">
...
export let listGrpTS4 = `<ul class="list-group list-group-flush">
...
export let listGrpTS5 = `  <div class="list-group">
...
export let listGrpTS6 = `<div class="list-group">
...
export let listGrpTS7 = ` <ul class="list-group">
...
export let listGrpTS8 = `  <div class="list-group">
...
export let listGrpTS9 = `<ul class="list-group">
<li class="list-group-item">A simple default list group item</li>
...
export let listGrpTS10 = `  <div class="list-group">
<a href="javascript:void(0);" class="list-group-item list-group-item-action active"
    aria-current="true">
...
export let listGrpTS11 = `<ol class="list-group list-group-numbered">
...
export let listGrpTS12 = `<ol class="list-group list-group-numbered">
<li class="list-group-item">Simply dummy text of the printing.</li>
<li class="list-group-item">There are many variations of passages.</li>
<li class="list-group-item">All the Lorem Ipsum generators.</li>
<li class="list-group-item">Written in 45 BC. This book is a treatise on the theory.</li>
...
export let listGrpTS13 = ` <ul class="list-group">
<li class="list-group-item">
...
export let listGrpTS14 = ` <ul class="list-group">
<li
...
export let listGrpTS15 = `  <ul class="list-group">
<li
    class="list-group-item d-flex justify-content-between align-items-center fw-semibold">
    Groceries
    <span class="badge bg-primary">Available</span>
...
export let listGrpTS16 = `  <div class="card-body">
<ul class="mb-3 list-group list-group-horizontal">
    <li class="list-group-item">An item</li>
    <li class="list-group-item border-start-0">A second item</li>
    <li class="list-group-item border-end">A third item</li>
</ul>
<ul class="mb-3 list-group list-group-horizontal">
    <li class="list-group-item">An item</li>
    <li class="list-group-item border-start-0">A second item</li>
