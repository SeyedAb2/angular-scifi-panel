...
export let CompleteEventData: any = {
    chart: {
        type: 'bar',
        height: 50,
        sparkline: {
...
export let PendingEventData: any = {
    chart: {
        type: 'line',
        height: 50,
        sparkline: {
...
export let UnsolvedEventData: any = {
    chart: {
        type: 'area',
        height: 50,
        sparkline: {
...
export let SafeZoneChartData: any = {
    series: [44, 55, 13, 43],
    chart: {
        height: 80,
        width: 80,
...
export let DangerZoneChartData: any = {
    series: [44, 55, 13, 43],
    chart: {
        height: 80,
        width: 80,
...
export let EnergyChartData: any = {
    chart: {
        height: 305,
        type: 'radar',
        toolbar: {
...
export let AirSupportChartData: any = {
    series: [{
...
export let sparkChartData1: any = {
    chart: {
        type: 'line',
        height: 20,
        width: 120,
...
export let sparkChartData2: any = {
    chart: {
        type: 'line',
        height: 20,
        width: 120,
...
export let sparkChartData3: any = {
    chart: {
        type: 'line',
        height: 20,
        width: 120,
...
export let sparkChartData4: any = {
    chart: {
        type: 'line',
        height: 20,
        width: 120,
...
export let sparkChartData5: any = {
    chart: {
        type: 'line',
        height: 20,
        width: 120,
...
export let TimeSpendChartData: any = {
    series: [{
        name: 'This Month',
        type: "column",
...
export let PopulationChartData: any = {
    series: [{
        name: 'population',
...
export let PopulationSupportChartData: any = {
    series: [{
        name: 'Revenue',
        type: 'area',
        data: [20, 29, 35, 35, 40, 39, 46],
    },
    ],
    chart: {
        toolbar: {
...
export let playersChartData: any = {
    series: [{
        name: 'Total',
